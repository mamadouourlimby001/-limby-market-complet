              ...
              <View key={msg._id} style={styles.card}>
                ...
                {isExpanded && (
                  <View style={styles.expanded}>
                    <View style={[styles.msgBubble, styles.msgBubbleBlue]}>
                      <Text style={styles.msgBubbleAuthor}>
                        {msg.sender?.nom} ({msg.sender?.telephone})
                      </Text>
...
const styles = StyleSheet.create({
  ...
  senderName: { fontSize: 13, fontWeight: '700', color: Colors.text },
  ...
  msgBubbleBlue: { backgroundColor: '#f3f4f6', borderLeftColor: '#3b82f6' },
  msgBubbleGreen: { backgroundColor: '#f0fdf4', borderLeftColor: Colors.success },
  msgBubbleAuthor: { fontSize: 12, fontWeight: '700', color: Colors.text, marginBottom: 4 },
