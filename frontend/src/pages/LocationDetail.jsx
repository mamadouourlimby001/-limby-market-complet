...
const LocationDetail = () => {
  ...
  return (
    <div className="page" style={{ padding: 0 }}>
      <div style={{ height: '70vh', width: '100vw', marginLeft: 'calc(-50vw + 50%)', marginRight: 'calc(-50vw + 50%)' }}><PhotoSlider photos={location.photos} height="100%" onPhotoClick={setExpandedPhotoIndex} /></div>
