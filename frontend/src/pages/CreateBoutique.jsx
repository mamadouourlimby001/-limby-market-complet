...
const CreateBoutique = () => {
  ...
  return (
    <div className="page" style={{ maxWidth: 500, margin: '0 auto' }}>
      ...
      <div className="alert alert-info" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><Info size={18} /> Votre boutique sera créée mais inactive. Pour l'activer, vous devez payer un abonnement de 10000 GNF et obtenir l'approbation d'un administrateur.</div>
