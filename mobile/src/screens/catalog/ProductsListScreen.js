      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View>
            ...
            <Button title="+ Nouvelle publication" variant="success" block style={{ marginBottom: 8 }} onPress={() => (user ? navigation.navigate('AddProduct') : navigation.navigate('Compte', { screen: 'Login' }))} />
